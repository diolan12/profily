...
<div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
        <div class="container">
            <div class="row center">
                <a href="parallax-1" class="animate">Just Test</a>
                <h5 class="header col s12 light white-text right-align animate">A modern responsive front-end framework based on Material Design</h5>
            </div>
        </div>
    </div>
        ...
        <div class="row hide">
            ...
            <div class="col s12 m6">
                <div class="icon-block">
                    <img src="<?= url('assets/img/coconut.png'); ?>" class="responsive-img materialboxed" alt="" />
                </div>
            </div>
            <div class="col s12 m6">
                <div class="icon-block scale-transition scale-out" scroll="product">
                    <h2 class="center pink-text"><i class="material-icons">flash_on</i></h2>
                    <h5 class="center">Speeds up development</h5>
