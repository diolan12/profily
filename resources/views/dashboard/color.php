                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 center">
                                <select id="primary-mod" onchange="primaryModChanged(this)">
                                    ...
                                    <?php foreach ($colors[$config->color->primary->val1] as $mod => $hex) : ?>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 center">
                                <select id="secondary-mod" onchange="secondaryModChanged(this)">
                                    ...
                                    <?php foreach ($colors[$config->color->secondary->val1] as $mod => $hex) : ?>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 center">
                                <select id="accent-mod" onchange="accentModChanged(this)">
                                    ...
                                    <?php foreach ($colors[$config->color->accent->val1] as $mod => $hex) : ?>
