...
<head>
    ...
    <title><?= $config->web->brand_text->val1 ?> - <?= ucwords($meta['title']) ?></title>
    ...
    <meta name="msapplication-TileColor" content="<?= $config->color->secondary->val3 ?>">
    <meta name="msapplication-TileImage" content="/ms-icon-144x144.png">
    <meta name="theme-color" content="<?= $config->color->secondary->val3 ?>">
</head>
