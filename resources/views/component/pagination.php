        ...
        <div class="col s12 center">
            <ul class="pagination">
                <li class="<?php if ($pagination->current == 1) echo 'disabled';
                    ...
                    <a href="<?= root($pagination->path) ?>"><i class="material-icons">chevron_left</i></a>
                </li>
                ...
                <li class="<?php if ($pagination->current == $pagination->total) echo 'disabled';
                    ...
                    <a href="<?= root($pagination->path . '?page=' . $pagination->total) ?>"><i class="material-icons">chevron_right</i></a>
                </li>
            </ul>
        </div>
    </div>
